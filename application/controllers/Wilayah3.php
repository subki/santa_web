...
class Wilayah3 extends IO_Controller {

    function __construct(){

        parent::__construct();
        $this->load->model('Wilayah3_model','model');
    ...
    function load_grid($regencies){
        ...
        if($fltr!=""){
            ...
            if(count($fltr)>0) $app .= " AND regency_id = $regencies ";
            else $app .= " where regency_id = $regencies ";
        }else{
            $app .= " where regency_id = $regencies ";
        }
