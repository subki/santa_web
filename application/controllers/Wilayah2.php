...
class Wilayah2 extends IO_Controller {

    function __construct(){

        parent::__construct();
        $this->load->model('Wilayah2_model','model');
    ...
    function load_grid($prov){
        ...
        if($fltr!=""){
            ...
            if(count($fltr)>0) $app .= " AND province_id = '$prov' ";
            else $app .= " where province_id = '$prov' ";
        }else{
            $app .= " where province_id = '$prov' ";
        }
    ...
    function load_grid2(){
		$f = $this->getParamGrid("","province_id");
