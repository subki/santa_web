...
class Rekapdaily_model extends CI_Model {
    ...
    public function __construct(){
        ...
        //                     ";
        $this->query = "SELECT SUM(dd.qty_order) qty_item,SUM(dd.qty_on_sales) qty_order, a.gross_sales,a.total_ppn,a.total_disc,a.sales_before_tax,a.sales_after_tax,a.id, a.no_faktur,a.no_faktur2, a.seri_pajak , a.doc_date, 
