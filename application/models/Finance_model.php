...
class Finance_model extends CI_Model {
	...
	public function __construct(){
        ...
        parent::__construct();
        $this->query = " SELECT a.docno, a.store_code, a.payment_type, a.payment_date, a.tipe_pos_biaya
	            ...
	            from cashbank_history a 
	            left join users u1 on a.crtby=u1.user_id
	            left join users u2 on a.updby=u2.user_id 
	            left join profile_p p on p.store_code=a.store_code
	            left join customer c on c.customer_code=a.customer_code ";
    }

    function ar_grid($page,$rows,$sort,$order,$role,$fltr){
