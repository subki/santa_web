...
<script src="<?php echo base_url(); ?>assets/js/rekapshowroom_grid.js"></script>
...
<div id="toolbar">
    <a href="<?php echo base_url(); ?>Rekapshowroom/form/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">New</a>
