...
<div id="tt">
    <div style="display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: space-between;">
        <a href="<?php echo base_url('Rekapdaily')?>" id="back" class="easyui-linkbutton" iconCls="icon-undo" style="width:90px; height: 20px;">Back</a>
        ...
        <a href="javascript:void(0)" id="getdate" class="easyui-linkbutton postdetail" iconCls="icon-search" style="width:90px; height: 20px;">Generate </a>
                    ...
                    <div style="width: 100%; padding: 10px;" class="border-kotak">
                        ...
                        <div style="margin-bottom:1px;">
                            ...
                            <p style="display: none">
                                <input name="seri_pajak_formatted" id="seri_pajak_formatted" readonly="true" class="easyui-textbox" labelPosition="top" tipPosition="bottom" label="Seri Pajak:" style="width:100%;display: none">
                            </p>
                        </div>
                        <div style="margin-bottom:1px">
            ...
            <div id="w" class="easyui-dialog" data-options="iconCls:'icon-save',closed:true,modal:true,border:'thin',buttons:'#dlg-buttons'" style="width:80%;height:300px;padding:10px;"> 
                <form action="" name="frm2" class="frm2" method="POST">
                   <div style="margin-bottom:20px">
                        <!-- <input id="dd"  class="easyui-datebox" label="Date:" data-options="labelPosition:'top',onSelect:onSelect"  labelPosition="top" style="width:50%;"> -->
                    </div>
                   <!--  <div style="margin-bottom:20px">
                        <input id="tdd" class="easyui-datebox" label="End Date:" labelPosition="top" style="width:50%;">
                    </div>  -->
                    <div style="margin-bottom:20px"> 
                        <a href="javascript:void(0)" id="searchdate" class="easyui-linkbutton save2" iconCls="icon-search"  style="width:90px; height: 20px;">Get</a>
                    </div>  
                    <div style="margin-bottom:20px"> 
                        <span id="l"></span> <br>
...
<script> 
    ...
    //      }
          ...
          $(".postdetail").click(function(){
            // var fromdate = $('#dd').datebox('getValue');
            // var todate = $('#tdd').datebox('getValue');
            var datenow = $('#doc_date').datebox('getValue');
            var customer_code = $('#customer_code').combogrid('getValue');  
                $.ajax({
                  type: 'POST',
                  dataType:"json",
