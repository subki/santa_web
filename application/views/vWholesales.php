...
<script src="<?php echo base_url(); ?>assets/js/ws_grid.js"></script>
...
<div id="toolbar">
    <a href="<?php echo base_url(); ?>Wholesales/form/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">New</a>
