...
<script src="<?php echo base_url(); ?>assets/js/rekapoutlet_grid.js"></script>
...
<div id="toolbar">
    <a href="<?php echo base_url(); ?>Rekapoutlet/form/add" class="easyui-linkbutton" iconCls="icon-add" plain="true">New</a>
