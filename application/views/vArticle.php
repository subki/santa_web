...
<div id="cc" class="easyui-layout" style="width:100%;height:100%">
    ...
    <div id="dlg" class="easyui-dialog" style="width:50%; height: 50%" data-options="closed:true,modal:true,border:'thin',buttons:'#dlg-buttons'">
...
<!--                        <input name="effdate" id="effdate" -->
<!--                               class="easyui-datebox" labelPosition="top" tipPosition="bottom" -->
<!--                               label="Effective Date:" style="width:100%">-->
<!--                      </div>-->
<!--                        <div style="float:left; width: 20%; padding-right: 5px;">-->
