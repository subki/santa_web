...
<script type="text/javascript">
	var options={
		...
		sortName:"effectivedate, description",
		sortOrder:"desc",
		toolbar:"#toolbar",
		singleSelect:true,
		...
		columns:[[
			...
			{field:"description",   title:"Payment Type",       width:'40%', sortable: true},
			{field:"effectivedate",   title:"Effective Date",       width:'20%', sortable: true},
			{field:"persen",   title:"Adm Fee",       width:'20%', sortable: true},
		]],
