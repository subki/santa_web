...
<script src="<?php echo base_url(); ?>assets/js/size.js"></script>
    ...
    <div data-options="region:'east'" style="width:30%;">
        <form id="fm" method="post" novalidate style="margin:0;padding:5px 5px">
            ...
            <div style="margin-bottom:10px">
                <input name="size_code" id="size_code" class="easyui-textbox" labelPosition="top" tipPosition="bottom" required="true" label="Kode:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
