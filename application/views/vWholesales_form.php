...
<script src="<?php echo base_url(); ?>assets/js/ws_form.js"></script>
...
<div id="tt">
  <div style="display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: space-between;">
    <a href="<?php echo base_url('wholesales')?>" id="back" class="easyui-linkbutton" iconCls="icon-undo" style="width:90px; height: 20px;">Back</a>
        ...
        <div class="border-kotak" style="width: 40%; padding: 10px; margin: 1px;">
          <div style="margin-bottom:1px">
            ...
            <div id="dis_faktur2" style="float:left; width: 55%; padding-right: 5px;">
              <input name="no_faktur2" id="no_faktur2" class="easyui-textbox khusus checkFaktur" labelPosition="top" tipPosition="bottom"
          ...
          <div style="margin-bottom:1px; display:block" id="vseri">
            <input name="seri_pajak_formatted" id="seri_pajak_formatted" readonly="true" class="easyui-maskedbox" mask="999.999.99.99999999" labelPosition="top" tipPosition="bottom" label="Seri Pajak:" style="width:100%">
          </div>
          <div style="margin-bottom:1px">
        ...
        <div class="border-kotak" style="width: 40%; padding: 10px; margin: 1px;">
          ...
          <div style="margin-bottom:1px">
            <input name="remark" id="remark" class="easyui-textbox" labelPosition="top" tipPosition="bottom"
                   required="true" label="Keterangan:" validType="length[0,50]" style="width:100%;">
          </div>
          <div style="margin-bottom:1px;display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: space-between;">
