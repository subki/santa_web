    ...
    <div class="content">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <th class="title-header text-center content2" width="8%" style="padding-left: 5px; padding-top: 2px; padding-bottom: 2px">QTY Uom</th>
...
<!--            <tr><th colspan="12"><div class="border-bottom-double"/></th></tr>-->
        ...
        <?php if(count($detail)<=8){ ?>
            ...
            <div class="kanan">
                <p class="content text-center">
                    Jakarta, <?php echo $header->ak_doc_date ?> <br/> 
