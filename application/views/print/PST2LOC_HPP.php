    ...
    <div class="content">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <th class="title-header text-center content" width="25%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Article</th>
                <th class="title-header text-center content" width="37%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Keterangan</th>
                <th class="title-header text-center content" width="15%" colspan="2" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">QTY</th>
                <th class="title-header text-center content" width="15%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Harga HPP</th>
                <th class="title-header text-center content" width="15%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Total HPP</th>
            </tr>
            <tr><th colspan="9"><div class="border-bottom-double"/></th></tr>
            </thead>
            <tbody>
            ...
            foreach ($detail as $row) { ?>
                    <tr>
                        ...
                        <td class="text-right content" style="padding-left: 10px; padding-top: <?php echo $i==1? '10px': '1px' ?>; padding-bottom: 1px"><?php echo number_format($row->hpp_ekspedisi,0,'.',',') ?></td>
                        <td class="text-right content" style="padding-left: 10px; padding-top: <?php echo $i==1? '10px': '1px' ?>; padding-bottom: 1px"><?php echo number_format($row->hpp_ekspedisi*$row->qty,0,'.',',') ?></td>
                    </tr>
                <?php $i++; $qty+=$row->qty; $prc+= ($row->hpp_ekspedisi*$row->qty); } ?>
            <tfoot>
                <tr>
                    ...
                    <td class="title-header text-right content" width="10%" colspan="3" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px"></td>
                    <td class="title-header text-right content" width="10%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px"><?php echo number_format($prc,0,'.',',')?></td>
                </tr>
            </tfoot>
            </tbody>
        </table>
