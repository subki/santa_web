            ...
            <div class="content">
                <table style="width: 100%;">
                    ...
                    <tr>
                        ...
                        <td class="text-center content" height="120px" width="34%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Gudang</td>
                    ...
                    <tr>
                        ...
                        <td class="text-center content" width="34%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">(_____________________)</td>
                        <td class="text-center content" width="33%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">(_____________________)</td>
                    </tr>
                    </tbody>
                </table>
