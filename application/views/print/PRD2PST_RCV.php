...
<table>
    ...
    <div class="content">
        <table style="width: 100%;">
            ...
            <tr>
                <th class="title-header text-center content" width="5%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">No.</th>
                ...
                <th class="title-header text-center content" width="35%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Article</th>
                <th class="title-header text-center content" width="45%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px">Keterangan</th>
            </tr>
            <tr><th colspan="5"><div class="border-bottom-double"/></th></tr>
            </thead>
            <tbody>
            ...
            foreach ($detail as $row) { ?>
                    <tr>
                        ...
                        <td class="text-left content" style="padding-left: 10px; padding-top: <?php echo $i==1? '10px': '1px' ?>; padding-bottom: 1px"><?php echo $row->article_name ?></td>
            ...
            <tfoot>
                <tr>
                    ...
                    <td class="text-left content" width="10%" style="padding-left: 10px; padding-top: 5px; padding-bottom: 5px"><?php echo ": ". $i-1 ."  <==> ". number_format($qty, 2, '.', ',') ?></td>
