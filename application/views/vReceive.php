...
<script src="<?php echo base_url(); ?>assets/js/receive_grid.js"></script> 
...
<script type="text/javascript">
    function addPoreceiving(){
        ...
        var supp = $('#supplier_codeid').val();
             $.redirect(base_url+"Poreceiving/form/add", {'tglnow': fromdate,'supp': supp}); 
    }  
    ...
    $('#supplier_code').combogrid({
             ...
             onSelect:function (index, rw) {
                ...
                if(status!==""){
                    $('#dg').datagrid({url:base_url+"Poreceiving/load_grid/"+status+"/"+rw.supplier_code+"/"+prd});
