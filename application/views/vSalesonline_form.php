...
<div id="tt">
    <div style="display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: space-between;">
        <a href="<?php echo base_url('Salesonline')?>" id="back" class="easyui-linkbutton" iconCls="icon-undo" style="width:90px; height: 20px;">Back</a>
    ...
    <div id="p" class="easyui-panel" title="<?php echo $title; ?>"
        ...
        <form id="fm" method="post" novalidate style="margin:0;padding:5px 5px">
            <div style="margin-bottom:1px;display: flex; flex-direction: row; flex-wrap: nowrap; justify-content: space-between;">
              <div style="width: 40%; padding: 10px;" class="border-kotak">
                ...
                <div style="width: 30%; padding: 10px;" class="border-kotak">
                    <div style="margin-bottom:1px">
