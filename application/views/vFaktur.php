    ...
    <div data-options="region:'east'" style="width:30%;">
        <form id="fm" method="post" novalidate style="margin:0;padding:5px 5px">
            ...
            <div style="margin-bottom:10px">
                <input name="total" id="total" class="easyui-numberbox" labelPosition="top" tipPosition="bottom" required="true" label="Total Copy:" style="width:100%">
            </div>
            <div style="margin-bottom:10px">
                <input name="awal" id="awal" class="easyui-textbox" labelPosition="top" tipPosition="bottom" required="true" label="Start Copy From(Not Include):" style="width:100%">
            </div>
