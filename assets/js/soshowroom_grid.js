var options={
    ...
    title:"Sales Order Showroomsales",
    method:"POST",
    pagePosition:"top",
    resizeHandle:"right",
    resizeEdge:10,
    ...
    toolbar:[{
        ...
        text:'New',
        handler: function(){
            window.location.href = base_url+"Showroomsales/form/add"
        }
    },{
        id:'edit',
        iconCls: 'icon-edit',
...
function editData(){
    let row = getRow();
    if(row==null) return
    window.location.href = base_url+"Showroomsales/form/edit?docno="+row.docno
}
